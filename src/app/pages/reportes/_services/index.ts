// Services
//export { HuespedService } from './fake/customers.service'; // You have to comment this, when your real back-end is done
export { EstatusService } from './fake/estatus.service'; // You have to comment this, when your real back-end is done
...
export { RemarksService } from './fake/remarks.service'; // You have to comment this, when your real back-end is done
 export { HuespedService } from './customers.service'; // You have to uncomment this, when your real back-end is done
